...
if (isset($_POST['submit'])) {
   ...
   if ($check_cart->rowCount() > 0) {
      ...
      if ($address == '') {
         ...
         $insert_order = $conn->prepare("INSERT INTO `orders`(user_id, name, number, email, method, address, total_products, total_price, pickup_time) VALUES(?,?,?,?,?,?,?,?,?)");
         $insert_order->execute([$user_id, $name, $number, $email, $method, $address, $total_products, $total_price, $pickup_time]);
   ...
   <section class="checkout">
      ...
      <form action="" method="post">
         ...
         <div class="user-info">
            ...
            <p>Pickup Time</p>
            <input type="datetime-local" name="pickup_time" value="<?= date('Y-m-d H:i:s') ?>" class="box" maxlength="50" style="margin-top: 0px;">
